...
require_once __DIR__ . '/Bootstrap.php'; // Corrected path
require_once __DIR__ . '/Db.php';        // Corrected path
require_once __DIR__ . '/Telegram.php';  // Corrected path
...
if (
    ...
    $new_credits = updateCredits($pdo, $uid, 5, true, false); 
    $fullResult =
        "<b>#BraintreeCharge</b>\n" .
        "━━━━━━━━━━━\n" .
